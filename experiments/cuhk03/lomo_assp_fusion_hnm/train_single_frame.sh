...
caffe/build/tools/caffe train -solver experiments_py_lomo/cuhk03/lomo_assp_fusion_hnm/solver.prototxt -gpu $1  \
-weights models/lomo/cuhk03/pretrained/fusion_hnm.caffemodel
