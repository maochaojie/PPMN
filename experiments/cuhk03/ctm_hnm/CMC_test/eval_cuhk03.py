...
def main():
    ...
    CMC_DIC = {}
    for iter_num in range(2000, 16000, 1000):
        cmc_list=[]
        for set_no in test_list:
            #init net
            MODEL_FILE = './experiments_py_lomo/cuhk03/lomo_hnm/deploy_lomo.prototxt'
            PRETRAINED = './models/lomo/cuhk03/lomo_hnm/15000_set02_iter_%d.caffemodel'%iter_num
            net = None
    ...
    save_root = 'experiments_py_lomo/cuhk03/lomo_hnm/CMC_test/'
