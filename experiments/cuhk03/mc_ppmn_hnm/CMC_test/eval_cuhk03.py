...
def main():
    ...
    for iter_num in range(2000, 20000, 2000):
        ...
        for set_no in test_list:
            #init net
            MODEL_FILE = './experiments_py_lomo/cuhk03/lomo_assp_fusion_hnm/deploy_twoflow_fusion.prototxt'
            PRETRAINED = './models/lomo/cuhk03/lomo_assp_fusion_hnm/20000_set02_iter_%d.caffemodel'%iter_num#30000_set02_v2_all_iter_%d.caffemodel'%iter_num
            net = None
    ...
    save_root = 'experiments_py_lomo/cuhk03/lomo_assp_fusion_hnm/CMC_test/'
