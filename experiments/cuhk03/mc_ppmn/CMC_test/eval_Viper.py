...
def readList(filename_test, num_id): 
    import random
    import os
    ...
    probes=[]
    gallerys=[]
    probe_id = num_id%2 #random.randint(0,1)
...
def calCMC(net,set_no,map_lomo,deep=True,rand_times=10):
    ...
    for i in range(rand_times):
        ...
        probes,gallerys=readList(list_name, i)
...
def main():
    ...
    for iter_num in range(5000, 10000, 5000):
        ...
        for set_no in test_list:
            #init net
            MODEL_FILE = 'experiments_py_lomo/Viper/lomo_assp_fusion/deploy_twoflow_fusion.prototxt'
            PRETRAINED = 'models/lomo/Viper/lomo_assp_fusion/10000_set02_iter_3000.caffemodel'##%iter_num
            net = None
            net = caffe.Classifier(MODEL_FILE, PRETRAINED,caffe.TEST)
            #caculate CMC
            cmc=calCMC(net,set_no,map_lomo,deep=True,rand_times=2)
            cmc_list.append(cmc)
    ...
    save_root = 'experiments_py_lomo/cuhk03_01_viper_100/lomo_assp_fusion/CMC_test/'
    save_mat_path = save_root + 'Viper_set02_yqCMC_100round_0423.mat'
    import scipy.io as sio
    sio.savemat(save_mat_path,{'ours':CMC_DIC})

    save_path = save_root + 'Viper_model_set02_10_yqCMC_10round_0423.png'
